...
/**
 * @brief Receives the raw ADC value from the assembly code and
 *        converts it to a temperature value.
 * 
 * @param raw 
 */
void printTemp(uint16_t raw) {
...
/**
 * @brief Main entry point for the code - calls the main assembly
